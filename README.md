...
**Status: early development.** Data model, migrations, authentication, user management, and core ticket CRUD with its lifecycle rule are in place and tested. CSV import, listing/filtering/pagination, and summary endpoints from `docs/requirements.md` are not implemented yet.
